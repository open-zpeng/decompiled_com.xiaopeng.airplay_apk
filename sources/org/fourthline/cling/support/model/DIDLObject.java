...
public abstract class DIDLObject {
    ...
    public static abstract class Property<V> {
        ...
        public void setOnElement(Element element) {
            ...
            for (Property<DIDLAttribute> attr : this.attributes) {
                String namespaceURI = attr.getValue().getNamespaceURI();
                element.setAttributeNS(namespaceURI, attr.getValue().getPrefix() + ':' + attr.getDescriptorName(), attr.getValue().getValue());
            }
        }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public DIDLObject(DIDLObject other) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public DIDLObject(String id, String parentID, String title, String creator, boolean restricted, WriteStatus writeStatus, Class clazz, List<Res> resources, List<Property> properties, List<DescMeta> descMetadata) {
        this.restricted = true;
        this.resources = new ArrayList();
        this.properties = new ArrayList();
        this.descMetadata = new ArrayList();
