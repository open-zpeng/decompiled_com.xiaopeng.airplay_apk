...
public class IncomingActionRequestMessage extends StreamRequestMessage implements ActionRequestMessage {
    ...
    public IncomingActionRequestMessage(StreamRequestMessage source, LocalService service) throws ActionException {
        ...
        if (this.action == null) {
            ...
            throw new ActionException(errorCode, "Service doesn't implement action: " + actionType.getActionName());
        } else if (!QueryStateVariableAction.ACTION_NAME.equals(actionType.getActionName()) && !service.getServiceType().implementsVersion(actionType.getServiceType())) {
