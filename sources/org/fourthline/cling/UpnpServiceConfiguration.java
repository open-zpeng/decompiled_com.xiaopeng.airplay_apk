...
public interface UpnpServiceConfiguration {
    ...
    ExecutorService getAsyncProtocolExecutor();

    ExecutorService getDatagramIOExecutor();
    ...
    ExecutorService getMulticastReceiverExecutor();

    Namespace getNamespace();

    ExecutorService getRegistryListenerExecutor();

    ExecutorService getRegistryMaintainerExecutor();
    ...
    ArrayBlockingQueue<Runnable> getUpnpStreamQueue();
